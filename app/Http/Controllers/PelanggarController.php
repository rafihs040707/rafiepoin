...
class PelanggarController extends Controller
{
    ...
    {   //validate form
        ...
        //redirect to index
        return redirect()->route('detailPelanggar.show', $request->id_pelanggar)->with(['succes' => 'Data Berhasil Disimpan!']);
    }
    ...
    public function updateStatus($datas, string $poin)
    {
        if ($poin >= 0 && $poin < 15) {
            //update post
            $katagoriPelanggar = 0;
